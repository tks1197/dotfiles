...
-- http://www.rtpro.yamaha.co.jp/RT/docs/lua/tutorial/library.html#pcall
 ...
 wezterm.on('update-status', function(window, pane)
   ...
   for _, b in ipairs(wezterm.battery_info()) do
     ...
     if battery_state_of_charge >= 80 then
       battery_icon = '🌕 '
     elseif battery_stateof_charge >= 70 then
       battery_icon = '🌖 '
     elseif battery_stateof_charge >= 60 then
       battery_icon = '🌖 '
     elseif battery_stateof_charge >= 50 then
       battery_icon = '🌗 '
     elseif battery_stateof_charge >= 40 then
       battery_icon = '🌗 '
     elseif battery_stateof_charge >= 30 then
       battery_icon = '🌘 '
     elseif battery_stateof_charge >= 20 then
       battery_icon = '🌘 '
     else
       battery_icon = '🌑 '
     end
 ...
 return {
   ...
   leader = leader,
   keys = keys,
   font = wezterm.font('Moralerspace Neon', { weight = 'Bold' }),
   font_size = 14,
   line_height = 1.25,
